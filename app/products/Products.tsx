              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-medium transition-all whitespace-nowrap border ${
                    isActive ? "" : "text-muted-foreground border-border hover:text-foreground hover:bg-secondary/40"
                  }`}
                  style={
                    isActive
                      ? {
    ...
    <div className="mb-12">
      ...
      <SpecTable
        ...
        rows={[
          ...
          ["OANT36-4MH-C", "4 ft Mesh Dish", "4.9-7.125 GHz", "35-36.5 dBi", "1.2 m", "2× N Male/Female"],
